...
- **🌍 3D OYUN DÜNYASI (ana arayüz)** — Oyun artık Three.js ile gerçek bir 3D dünyadan yönetilir: galeri kompleksiniz üç boyutlu binalarla yükselir, kamerayı sürükleyerek döndürür, tekerlek/iki parmakla yakınlaşırsınız. **Binalara tıklamak ilgili ekranı panel olarak sahnenin üzerine kaydırır** (Vitrin→Galerim, Tamirhane→Atölye, reklam panosu→İlanlar, bayrak→Lig, Ofis kulübesi→Ofis; diğer dükkanlar→Tesis). Dünya canlıdır: yoldan 3D trafik akar, pompaya müşteri yanaşıp "+₺" bırakır, yıkamada köpükler yükselir, atölyede iş varsa kıvılcım fışkırır, müşteriler kaldırımda gezinir, bayrak dalgalanır; oyun saatine göre gün batar, gece bina camları ışıldar. Bina seviyeleri yükseldikçe 3D modeller büyür. Sekme çubuğu yerine oyun tarzı alt HUD (rozetli) vardır.
- **🎮 Tam ekran oyun arayüzü (diegetik HUD)** — 3D dünya tüm ekranı kaplar; kasa/gün/itibar çubuğu ve oyun tuşları sahnenin içinde yarı saydam HUD olarak durur. Bir binaya, müşteriye ya da tuşa dokununca **kamera oraya uçar** ve ilgili ekran mobil oyun kartı gibi sahnenin üstünde açılır; kapatınca kamera genel görünüme süzülür.
- **🛒 Raf düzeninde ilan pazarı** — İlanlar yatay kaydırılan raflarda: 🔥 Fırsat rafı (acil satılıklar), 📍 Bulunduğun il, 🚗 Yakın iller (≤300 km), 🗺️ Uzak iller. Karta dokununca modal yerine ekran içinde kayarak detaya geçilir ("← Raflara Dön").
- **🚗 Kendin sürerek getirme** — Pazarlık bitince seçim: 🚚 Nakliyeyle gönder (ücretli, uzaksa yarın gelir) ya da **🚗 Kendin Sür (3D)**: nakliye bedava, mesafeye göre 15–60 saniyelik 3D yolculuk (kalan km göstergesiyle), araç hemen vitrinde ve siz galeriye dönmüş olursunuz. Riskler sizde: gizli arızalı araç yolda kalabilir (çekici ücreti + arıza ortaya çıkar), trafiğe çarparsanız hasar bedeli ve parça yıpranması. Sürüşte fark ettiğiniz arızalar bilinen arıza olur. Reducer testi: `npm run test:buy-sur`.
- **🏎️ 3D test sürüşü** — Test sürüşü artık üç boyutlu: arkadan kamera, 3 şeritli otoyol, yol kenarı ağaçları, gerçek trafik. Arızalar 3D sürüş hissine yansır: rot çekmesi araç sağa kayar, zayıf fren geç durdurur, motor teklemesi kamerayı titretir, yağ yakan motor arkada duman bırakır, hararet göstergesi yükselir. Çarpışma = kaza + hasar tazminatı. Klavye (ok/WASD) veya ekrandaki iki başparmak pedalları.
- **🛣️ Yolculuk sineması** — Başka ile giderken tam ekran araba içi geçiş oynar: ön camdan akan yol, kayan tepeler, direksiyon sallanır, hız ibresi titrer, yaklaşan yeşil tabelada hedef şehir ve kalan km yazar; gece yolculuklarında farlar yolu aydınlatır. Süre mesafeye göre uzar (Geç ⏭ ile atlanabilir) ve HER seyahatte otomatik tetiklenir (harita, ilan, mezat).
- **🏗️ 3D inşaat animasyonu** — Tesiste bir dükkan kurunca/yükseltince bina 3D dünyada toz bulutları arasında yerden yükselir, üstünde çekiç sallanır. Kaldırımdaki yürüyen müşteriler artık tıklanabilir (Müşteriler panelini açar) ve yürüme salınımıyla hareket eder — mobilde dokunmatik dahil.
